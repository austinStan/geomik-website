...
class Soliloquy_Common {
	 ...
	 */
	public function resize_image( $url, $width = null, $height = null, $crop = true, $align = 'c', $quality = 82, $retina = false, $data = array() ) {
	 ...
	 * @return array
	 */
	public function sort_slides( $data, $sort_type, $sorting_direction = 'asc' ) {

		// print_r ( $sorting_direction ); exit;
		...
		$sorting_direction = strtolower( $sorting_direction );
