        ...
        <div class="mec-skins-options-container">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_carousel_skin_options_container">
                ...
                <div class="mec-form-row">
                    ...
                    <input class="mec-col-4" type="number" min="0" step="1" name="mec[sk-options][carousel][autoplay]" id="mec_skin_carousel_autoplay" placeholder="<?php _e('eg. 3000 default is 3 second', 'mec'); ?>" value="<?php if(isset($sk_options_carousel['autoplay']) && $sk_options_carousel['autoplay'] != '') echo $sk_options_carousel['autoplay']; ?>" />
                </div>
                <div class="mec-form-row mec-switcher">
                    <div class="mec-col-4">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_slider_skin_options_container">
                ...
                <div class="mec-form-row">
                    ...
                    <input class="mec-col-4" type="number" min="0" step="1" name="mec[sk-options][slider][autoplay]" id="mec_skin_slider_autoplay" placeholder="<?php _e('eg. 3000 default is 3 second', 'mec'); ?>" value="<?php if(isset($sk_options_slider['autoplay']) && $sk_options_slider['autoplay'] != '') echo $sk_options_slider['autoplay']; ?>" />
                </div>
                <div class="mec-form-row">
