...
class MEC_feature_coupons extends MEC_base
{
    ...
    public function apply_coupon()
    {
        ...
        else
        {
            ...
            $this->main->response(array('success'=>1, 'message'=>sprintf(__('Coupon valid and you get %s discount.', 'mec'), $this->main->render_price($discount, $event_id)), 'data'=>array('discount'=>$discount, 'price_raw'=>$transaction['price'], 'price'=>$this->main->render_price($transaction['price'], $event_id), 'price_details'=>$price_details, 'transaction_id'=>$transaction_id)));
        }
    }
