    ...
    */
    ...
    public function get_flags($event, $date = NULL)
    {
        ...
        if(is_array($availability) and count($availability))
        {
            ...
            if(($total_bookings_limit > 0) and ($remained_tickets > 0 and $remained_tickets <= round((($percentage * $total_bookings_limit) / 100)))) return str_replace('%%title%%', __('Last Few Tickets', 'mec'), $output_tag);
