...
$grid_settings = array(
		...
		'fields' => array(	
			...
			array(
				'id'   => $prefix.'instagram_access_token',
				'name' => __( 'Access Token', 'tg-text-domain' ),
				'desc' => __( 'Enter your access token', 'tg-text-domain' ),
				'sub_desc' =>__( 'Follow our instructions to get your own <a href="https://theme-one.com/docs/the-grid/#social_media_instagram" target="_blank">Instagram Access Token</a>.', 'tg-text-domain' ),
				'type' => 'text',
				'std'  => '',
				'tab' => __( 'Source', 'tg-text-domain' )
			),
